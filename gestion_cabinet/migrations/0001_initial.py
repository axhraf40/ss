# Generated by Django 4.2.7 on 2025-05-31 15:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('PATIENT', 'Patient'), ('DENTISTE', 'Dentiste'), ('SECRETAIRE', 'Secrétaire')], default='PATIENT', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='dentiste_profile', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut_paiement', models.CharField(choices=[('EN_ATTENTE', 'En attente'), ('REGLE', 'Réglé')], default='EN_ATTENTE', max_length=20)),
        ...
        migrations.AddField(
            ...
            name='rendez_vous',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='gestion_cabinet.rendezvous'),
        ),
    ]
